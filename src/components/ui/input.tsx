    ...
    return (
      <>
        <div className="w-full flex justify-center items-center gap-2">
          <div className="relative w-full min-w-[200px] h-10 flex justify-center items-center gap-1">
            <input
              type={type}
        ...
        <div>
          {error && (
            <span className="block -mt-4 ml-2 text-brand-red text-sm text-red-600">
              {error.message}
            </span>
          )}
        </div>
