...
interface AlertDeleteCategoriaProps {
...
export default function AlertDeleteCategoria(props: AlertDeleteCategoriaProps) {
              ...
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">EXCLUIR CATEGORIA</h3>
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        A exlcusão apaga todos os registros da categoria no Banco de Dados, assim todos os produtos referentes a essa categoria serão deletados.
                      </p>
                      <span className="text-sm text-gray-500 font-medium">Você tem certeza que deseja realizar a exclusão dessa categoria?</span>
                    </div>
                  </div>
                </div>
              </div>
