...
type AuthContextData = {
  ...
  produtoSelecionado?: ProdutosData;
  setprodutoSelecionado?: (produto: ProdutosData) => void;
  pedidoSelecionado?: PedidosData;
  setpedidoSelecionado?: (pedido: PedidosData) => void;
};
...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  const [duplicataSelecionada, setduplicataSelecionada] =
    useState<DuplicatasData>();
  const [categoriaSelecionada, setcategoriaSelecionada] =
    useState<CategoriasData>();
  const [produtoSelecionado, setprodutoSelecionado] = useState<ProdutosData>();
  const [pedidoSelecionado, setpedidoSelecionado] = useState<PedidosData>();
  ...
  async function getPedidoFromStorage(storedPedido: string) {
    ...
    const pedidoSelecionado = response.data;
